...
namespace Editors
{
    public class ReplaceFontEditorWindow : EditorWindow
    {
        ...
        [SerializeField] private List<UnityEngine.UI.Text> specifiedLegacyTextObjects = new List<Text>();
        [SerializeField] private List<TextMeshProUGUI> specifiedTMPObjects = new List<TextMeshProUGUI>();
